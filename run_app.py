            ...
            for x in executors:
              for y in executor_cores:    
                for i in range(int(rep)):
                  ...
                  os.system('python3 wordCountConfig.py '+str(app)+' '+str(r)+' '+str(s)+' '+str(x)+' '+str(t)+' '+str(y)+' '+n+' + '+str(mode)+' '+str(log_dir)+' '+str(rep)+' '+str(dataset))
  else:
    for r in driver_cores:
      for s in driver_mem:
        for t in executor_mem:    
          for x in executors:
            for y in executor_cores:    
              for i in range(int(rep)):
                ...
                print("Executor Memory: "+str(t))
                print("Executor Cores: "+str(y))
                os.system('python3 wordCountConfig.py '+str(app)+' '+str(r)+' '+str(s)+' '+str(x)+' '+str(t)+' '+str(y)+' + '+str(mode)+' '+str(log_dir)+' '+str(rep)+' '+str(dataset))
